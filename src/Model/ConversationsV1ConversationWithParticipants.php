...
/** A Conversation created with initial Participants — `/v1/ConversationWithParticipants`. */
final class ConversationsV1ConversationWithParticipants implements Model
{
    /**
