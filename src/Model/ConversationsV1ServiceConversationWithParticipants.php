...
/** Service-scoped Conversation created with initial Participants — `/v1/Services/{ChatServiceSid}/ConversationWithParticipants`. */
final class ConversationsV1ServiceConversationWithParticipants implements Model
{
    /**
