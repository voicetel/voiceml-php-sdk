...
/** Service-scoped Conversation Participant — Twilio Conversations v1 `MB…` under `/v1/Services/{ChatServiceSid}`. */
final class ConversationsV1ServiceConversationParticipant implements Model
{
