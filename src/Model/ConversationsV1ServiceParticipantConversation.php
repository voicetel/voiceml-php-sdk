...
/** Service-scoped Participant Conversation summary — `/v1/Services/{ChatServiceSid}/ParticipantConversations`. */
final class ConversationsV1ServiceParticipantConversation implements Model
{
    /**
